...
CkEditorImageBrowser.init = function () {
	...
	//CkEditorImageBrowser.loadData(CkEditorImageBrowser.getQueryStringParam('Showdanhsachanhduocchiase'), function () {
	//	CkEditorImageBrowser.initFolderSwitcher();
	//});
	//CkEditorImageBrowser.loadData(CkEditorImageBrowser.getQueryStringParam('Showdanhsachdulieutrongthumuc'), function () {
	//    CkEditorImageBrowser.initFolderSwitcher();
	//});
};
