...
(function ($)
{
    $.fn.jCarouselLite = function (o) {
        ...
        return this.each(function () {
            ...
            c.css({ overflow: "hidden", position: "relative", "z-index": "2", left: "0px", height: "450px" });
            ...
            function go(a) {
                if (!b) {
                    ...
                    if (o.circular) {
                        if (a <= o.start - v - 1) { ul.css(animCss, -((itemLength - (v * 2)) * g) + "px"); curr = a == o.start - v - 1 ? itemLength - (v * 2) - 1 : itemLength - (v * 2) - o.scroll } else if (a >= itemLength - v + 1) { ul.css(animCss, -((v) * g) + "px"); curr = a == itemLength - v + 1 ? v + 1 : v + o.scroll }
                        else curr = a
                    } else {
    ...
    function width(a)
    {
        var widthd = a[0].offsetWidth + css(a, 'marginLeft') + css(a, 'marginRight'); console.log(widthd); return widthd;
    };
    function height(a)
    {
